...
BS = BlackScholes(option_BS)
BSM = BlackScholesMerton(option_BSM)
BSF = BlackScholesFutures(option_BSF)
BSA = BlackScholesAsay(option_BSA)
BSC = BlackScholesCurrency(option_BSC)
BSG = GBlackScholes(option_GBS)
